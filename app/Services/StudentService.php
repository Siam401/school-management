...
class StudentService {
    ...
    public function getStudentsByClassSectionGroup($classId = null, $sectionId = null, $groupId = null) {
        ...
        $query = Student::query()
            ->select('users.*', 'student_sessions.roll', 'classes.class_name', 'sections.section_name', 'students.id as id', 'student_groups.group_name', 'students.user_id', 'students.first_name', 'students.last_name')
