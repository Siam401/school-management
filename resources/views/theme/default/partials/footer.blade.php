                                ...
                                <div class="company_info">
                                    ...
                                    <ul class="quick_link">
                                        @foreach ($navItem['children'] as $child)
                                            <li>
                                                <a href="{{ url($child['link']) }}" style="color:{{ get_option('frontend_footer_text_color') }}">
                                                    {{ __($child['menu_label']) }}
                                                </a>
                                            </li>
                                        @endforeach
...
<footer class="second_footer">
    <div class="container">
        <div class="ft_content"
            style="background:{{ get_option('frontend_footer_bg_color') }}>
            <p style="color:{{ get_option('frontend_footer_text_color') }}">
            © 2022 Notre Dame College Mymensingh - All
            Right Reserved.</p>
            <p style="color:{{ get_option('frontend_footer_text_color') }}">Developed By
                <a style="color:{{ get_option('frontend_footer_text_color') }}" href="https://squartup.com/"
                    target="_blank">
                    SquartUp
                </a>
            </p>
