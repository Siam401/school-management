    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form
          ...
          class="validate"
          autocomplete="off"
          action="{{ route('quick-collection.store') }}"
          autocomplete="off"
        >
          @csrf
          ...
          <div class="row p-4">
            ...
            @php // dd($studentSession->student->user->image); @endphp
            <div class="col-lg-6">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width: 220px">
                        <input
                          type="hidden"
                          name="fee_sub_head_id"
                          value="{{ $feeHead->id }}"
                        />
                        <select
                          name="fee_heads[{{ $feeHead->id }}][sub_head_ids][]"
                          id="sub_head_id_{{ $feeHead->id }}"
                          class="sub_head_ids form-control select2"
                          multiple
                      ...
                      <td>
                        <input
                          ...
                          id="fee_and_fine_payable_{{ $feeHead->id }}"
                          readonly
                        />
                      </td>
                      <td>
                        <input
                          ...
                          id="previous_due_payable_{{ $feeHead->id }}"
                          readonly
                        />
                      </td>
                      <td>
                        <input
                          ...
                          id="previous_due_paid_{{ $feeHead->id }}"
                          readonly
                        />
                      </td>
                      <td>
                    ...
                    <tr>
                      <td colspan="12" class="text-center">
                        <h6>
                          {{
                            _lang(
                              "No Fee Head Found. Please create or configure fee head first."
                            )
                          }}
                        </h6>
                      </td>
          ...
          <div class="row" style="margin-top: 50px">
            <div class="col-md-6">
              ...
              <input type="hidden" id="attendance_fine_value" />
              ...
              <div class="form-group">
                <div class="form-group">
                  ...
                  <select
                    class="form-control select2"
                    name="absent"
                    onchange="getAbsentAmount(this.value)"
                    required
                  >
                    <option value="0">Select</option>
                    @foreach($attendence as $row) @php $month = ['Jan', 'Feb',
            ...
            <div class="col-md-3">
              <div class="form-group">
                <textarea
                  ...
                  cols="4"
                  rows="8"
                  placeholder="{{ __('Enter Notes (if any)') }}"
                  >{{ old("note") }}</textarea
                >
              </div>
